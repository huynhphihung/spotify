...
export default function DetailSong() {
    ...
    return (
        <div className="col-span-1 p-3 bg-slate-700 fixed w-full top-24 z-40 lg:relative lg:top-0">
            <h2 className="text-cyan-500 font-bold text-center lg:text">Now playing</h2>
